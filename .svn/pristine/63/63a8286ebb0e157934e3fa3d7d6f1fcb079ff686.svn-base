...
namespace webapi_yzy
{
    public class BaseSqlZhyf
    {
        ...
        /// </summary>
        public static readonly string connectString = configuration["DBSetting:ConnectStringZhyf"];

        public static BaseSqlZhyf us = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static BaseSqlZhyf getInstance()
        {
            if (us == null) us = new BaseSqlZhyf();
            return us;
        }
