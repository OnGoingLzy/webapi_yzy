...
namespace webapi_yzy.Controllers
{
    ...
    public class TradeController : Controller
    {
        ...
        public async Task<ActionResult> yinhaiTest(object obj)
        {
            ...
            string encryptReqData = yhtool.Encrypt(reqData);
            //设置输入报文
            yinhaiInputObject.input = encryptReqData;         
            //生成签名
            string sign_data = yhtool.GenerateSignature(timestamp, sender_trns_sn, encryptReqData, "P53050201208");
            ...
            if(yhtool.VerifySignature((string)res["timestmp"], (string)res["sign_data"], (string)res["recer_trns_sn"], (string)res["output"]))
            {
        ...
        public async Task<ActionResult> requestYinhaiQueryOrder(object obj)
        {
            ...
            try
            {
                ...
                string jsonData = yhtool.generateYinhaiQueryOrderParam(main_order_id);
        ...
        public async Task<ActionResult> requestYinhaiQueryRefundOrder(object obj)
        {
            ...
            try
            {
                ...
                JObject bodyObject = JObject.Parse(trueBody);
                string main_order_id = bodyObject["main_order_id"] == null ? "" : bodyObject["main_order_id"].ToString();
                string jsonData = yhtool.generateYinhaiQueryRefundOrderParam(main_order_id);
